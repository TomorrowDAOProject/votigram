...
describe('VoteItem Component', () => {
  ...
  it('handles vote button click', () => {
    const onVoted = vi.fn();
    render(<VoteItem data={mockData} proposalId="1" canVote={true} showBtn={true} onVoted={onVoted} />);
  ...
  it('displays confetti when vote button is clicked', () => {
    render(<VoteItem data={mockData} proposalId="1" showBtn={true} canVote={true} />);
